...
import java.util.*;
import java.io.*; // �뙆�씪 �겢�옒�뒪 �궗�슜�쓣 �쐞�븳 �엫�룷�듃 異붽�
import javax.imageio.*;
import java.awt.image.*;// 踰꾪띁�씠誘몄� �겢�옒�뒪 �궗�슜�쓣 �쐞�븳 �엫�룷�듃 異붽�
...
public class PlayerRocket {
    ...
    public void Draw(Graphics2D g2d)
    {
        ...
        g2d.drawString("Life: 5", 5, 30 );
        
        if(Game.RocketN ==0) {
        	g2d.drawString("Rocket 1 coordinates: " + x + " : " + y, 5, 15);
        }  else if(Game.RocketN1==1){
        ...
        else
        {
            ...
            if(Canvas.keyboardKeyState(KeyEvent.VK_W)&& Game.RocketN == 0 )
                g2d.drawImage(rocketFireImg, x + 12, y + 66, null);
            if(Canvas.keyboardKeyState(KeyEvent.VK_UP)&& Game.RocketN1 == 1 )
            	 g2d.drawImage(rocketFireImg, x + 12, y + 66, null);
